...
public class Reserve extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("101 - Swimming pool  ");

        jLabel3.setText("102 - Community Hall");

        jLabel5.setText("103 - Mini Theater");

        jLabel6.setText("ResID :");

        jLabel7.setText("AmenityID :");
    ...
    String dur = t4.getText();
     ...
     try{
        ...
        String query = "insert into reservation values('"+id+"','"+aid+"','"+date+"','"+dur+"')";
